...
import com.example.pro.watts_hut.activities.MainActivity;
import com.example.pro.watts_hut.activities.MainActivityUsingFragment;
import com.example.pro.watts_hut.activities.MovieReviews;
...
import com.example.pro.watts_hut.databinding.MovieDetailConstrainedBinding;
...
import static com.example.pro.watts_hut.data.FavoriteMoviesContract.favoriteMovies.COLUMN_IS_FAVORITE;
import static com.example.pro.watts_hut.data.FavoriteMoviesContract.favoriteMovies.COLUMN_MOVIE_DB_ID;
import static com.example.pro.watts_hut.data.FavoriteMoviesContract.favoriteMovies.COLUMN_MOVIE_TITLE;
import static com.example.pro.watts_hut.data.FavoriteMoviesContract.favoriteMovies.COLUMN_RATINGS;
import static com.example.pro.watts_hut.data.FavoriteMoviesContract.favoriteMovies.COLUMN_RELEASE_DATE;
import static com.example.pro.watts_hut.data.FavoriteMoviesContract.favoriteMovies.COLUMN_SYNOPSIS;
import static com.example.pro.watts_hut.data.FavoriteMoviesContract.favoriteMovies.COLUMN_THUMBNAIL;
import static com.example.pro.watts_hut.data.FavoriteMoviesContract.favoriteMovies.COLUMN_USER_ID;
import static com.example.pro.watts_hut.data.FavoriteMoviesContract.favoriteMovies.COLUMN_VOTE_COUNT;
import static com.example.pro.watts_hut.data.FavoriteMoviesContract.favoriteMovies.TABLE_NAME;
import static com.example.pro.watts_hut.data.FavoriteMoviesContract.favoriteMovies._ID;
...
public class MovieDetailsFragment extends Fragment {
    ...
    MovieDetailConstrainedBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.inflate(
                inflater, R.layout.movie_detail_constrained, container, false);
        View view = binding.getRoot();
        binding.watchTrailer.setOnClickListener(mButtonClickListener);
        binding.reviewButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((MainActivityUsingFragment) getActivity()).goToReview(movieDbId, reviewsList);
            }
        });
    ...
    private void fillData() {
        ...
        // Get the db
        FavoriteMoviesHelper helper = FavoriteMoviesHelper.getHelper(getActivity());
    ...
    public void switchFavorite(View view) throws Exception {
        ...
        ((MainActivityUsingFragment) getActivity()).refreshFavorites();
    ...
    public void loadDetails() {
        ...
        try {
            ...
            new MovieDetailsFragment.LoadDetailTask().execute(url);
            new MovieDetailsFragment.LoadReviewsTask().execute(urlReviews);
